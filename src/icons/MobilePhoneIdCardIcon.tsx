...
function MobilePhoneIdCard(props: Props) {
    return (
        <svg
        ...
        >
            ...
            <path fill="#C2EAF7" d="M3 3.5H26V16.5H3z"></path>
            <path
                fill="#E7E9E9"
                fillRule="evenodd"
                ...
                clipRule="evenodd"
            ></path>
            <path fill="#78706A" fillRule="evenodd" d="M17 46.5a2 2 0 11-4 0 2 2 0 014 0z" clipRule="evenodd"></path>
            <path
                fill="#669DB4"
...
export default styled(MobilePhoneIdCard)`
    width: 29px;
`;
